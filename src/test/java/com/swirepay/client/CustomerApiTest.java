...
public class CustomerApiTest {
    ...
    public void addCustomerTest() {
        ...
        CustomerResponse response = api.addCustomer(customerRequest, destinationAccount);
    ...
    public void deleteCustomerByGidTest() {
        String gid = null;
        String destinationAccount = null;
        api.deleteCustomerByGid(gid, destinationAccount);
    ...
    public void getAllCustomersTest() {
        ...
        Integer size = null;
        String destinationAccount = null;
        CustomerListResponse response = api.getAllCustomers(page, size, destinationAccount);
    ...
    public void getCustomerByGidTest() {
        String gid = null;
        String destinationAccount = null;
        CustomerResponse response = api.getCustomerByGid(gid, destinationAccount);
    ...
    public void updateCustomerTest() {
        ...
        String destinationAccount = null;
        CustomerRequest customerRequest = null;
        CustomerResponse response = api.updateCustomer(gid, destinationAccount, customerRequest);
