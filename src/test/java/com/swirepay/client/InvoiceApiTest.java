...
public class InvoiceApiTest {
    ...
    public void addInvoiceTest() {
        ...
        InvoiceResponse response = api.addInvoice(invoiceRequest, destinationAccount);
    ...
    public void payInvoiceTest() {
        ...
        String destinationAccount = null;
        InvoiceRequest invoiceRequest = null;
        InvoiceResponse response = api.payInvoice(gid, destinationAccount, invoiceRequest);
    ...
    public void updateInvoiceActiveTest() {
        ...
        String destinationAccount = null;
        InvoiceRequest invoiceRequest = null;
        InvoiceResponse response = api.updateInvoiceActive(gid, destinationAccount, invoiceRequest);
    ...
    public void updateInvoiceDraftTest() {
        ...
        String destinationAccount = null;
        InvoiceRequest invoiceRequest = null;
        InvoiceResponse response = api.updateInvoiceDraft(gid, destinationAccount, invoiceRequest);
