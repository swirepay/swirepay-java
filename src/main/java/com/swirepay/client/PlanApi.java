...
public class PlanApi {
     ...
     */
    public PlanResponse getPlan(String xApiKey) throws RestClientException {
        return getPlanWithHttpInfo(xApiKey).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PlanResponse> getPlanWithHttpInfo(String xApiKey) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'xApiKey' is set
        if (xApiKey == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xApiKey' when calling getPlan");
        }
