...
public class PayoutApi {
     ...
     */
    public PayoutResponse getPayout(String xApiKey) throws RestClientException {
        return getPayoutWithHttpInfo(xApiKey).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<PayoutResponse> getPayoutWithHttpInfo(String xApiKey) throws RestClientException {
        Object postBody = null;
        
        // verify the required parameter 'xApiKey' is set
        if (xApiKey == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'xApiKey' when calling getPayout");
        }
